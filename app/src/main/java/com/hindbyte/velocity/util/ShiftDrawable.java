...
public class ShiftDrawable extends DrawableWrapper {
    ...
    public boolean setVisible(boolean visible, boolean restart) {
        @SuppressLint("RestrictedApi") final boolean result = super.setVisible(visible, restart);
        if (isVisible()) {
            mAnimator.start();
        } else {
            mAnimator.end();
    ...
    protected boolean onLevelChange(int level) {
        @SuppressLint("RestrictedApi") final boolean result = super.onLevelChange(level);
        updateBounds();
        return result;
    }
    ...
    public void draw(Canvas canvas) {
        @SuppressLint("RestrictedApi") final Drawable d = getWrappedDrawable();
